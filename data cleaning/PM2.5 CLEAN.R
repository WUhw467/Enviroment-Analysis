#import dataset
mydata <- read.csv("/Users/hengxinwu/Desktop/DS Homework/501 Portfolio/data gathering/AirNow csv/PM2.5.csv")
...
write.csv(mydata, "CleanPM2.5.csv", row.names = FALSE)
...
plot (mydata$AQI, xaxt="n", type = "l", main = "PM2.5")
